...
class FoodMenuEdit extends StatelessWidget {
  ...
  FoodMenuEdit(
      {required this.controller, this.width = 360, this.height = 600});
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: ListView(
          children: [
            FoodMenuDetailEditable(controller.foodMenu, isEditable: true, formController: controller.formController),
            Row(
              ...
              children: [
                SubmitButton("削除",
                    ...
                    onPressed: controller.handleTapDeleteButton),
                SubmitButton("保存",
                    icon: Icons.save,
